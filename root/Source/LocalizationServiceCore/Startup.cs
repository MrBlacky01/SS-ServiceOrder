...
using LocalizationServiceCore.Repositories.Implementations;
using LocalizationServiceCore.Repositories.Interfaces;
using LocalizationServiceCore.Services.Implementations;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<Settings>(options =>
            {
                ...
                var collections = Configuration.GetSection("MongoConnection:Collections");
                foreach (var collection in collections.GetChildren())
                {
                    options.Collections.Add(collection.Key,collection.Value);
                }
            });
        }
